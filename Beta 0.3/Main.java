...
public class Main{
	public static void main(String[] args) {
		...
		try{
			BufferedReader file = new BufferedReader(new FileReader("src/diccionario.txt"));
			String line;
			while((line = file.readLine()) != null ){
				...
				while(count<line.length()){
					...
					count++;
					arbol.addElement(arbol.getRaiz(),english, spanish);
				}
				/*
		...
		*/
		String traduccion="";
		try{
			BufferedReader file = new BufferedReader(new FileReader("src/texto.txt"));
			String line;
			...
			while((line = file.readLine()) != null ){
				...
				while(count<line.length()){
					if(line.charAt(count)!=' ' & line.charAt(count)!='.')
						...
						traduccion = arbol.getTraduccion(arbol.getRaiz(),word);
						/*
